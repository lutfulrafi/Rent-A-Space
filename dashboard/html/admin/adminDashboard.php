...
$sql3 = "SELECT COUNT(room_id) AS TOTAL_ROOM FROM ROOM WHERE host_id=$host_id ";
$result3 = mysqli_query($conn, $sql3);
$info3 = mysqli_fetch_all($result2, MYSQLI_ASSOC);
$data3 = mysqli_fetch_assoc($result3);
$total_room = $data3['TOTAL_ROOM'];
                ...
                <div class="row row-cols-1 row-cols-md-4 g-4">
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Total Room <img src="../../ICONS/bed.png" height="50px"
                                        width="50px" style="float: right;" class="card-img-left" alt="..."></h5>
                                <p class="card-text"></p>
                                <p class="card-text"></p>
                                <p class="card-text" style="font-size: 30px;">&nbsp;<?php echo $total_room ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Total Booked <img src="../../ICONS//booked.png" height="50px"
                                        width="50px" style="float: right;" class="card-img-left" alt="..."></h5>
                                <p class="card-text"></p>
                                <p class="card-text"></p>
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Monthly booked <img src="../../ICONS/calender.png" height="50px"
                                        width="50px" style="float: right;" class="card-img-left" alt="..."></h5>
                                <p class="card-text"></p>
                                <p class="card-text"></p>
