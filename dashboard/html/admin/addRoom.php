...
if(isset($_POST['submit'])){ 
    ...
    $toilet=$wifi=$air=$statusMsg = $errorMsg = $insertValuesSQL1 = $insertValuesSQL2 = $errorUpload = $errorUploadType = $house=$address=$sbed=$dbed=$city= $host_id ='';
    ...
    if(!empty($fileNames)){ 
        ...
        $insertValuesSQL2 .= "('".$insertValuesSQL1."','".$host_id."','".$house."','".$address."','".$sbed."','".$dbed."','".$city."','".$air."','".$wifi."','".$toilet."' )";
        // Error message 
        $errorUpload = !empty($errorUpload)?'Upload Error: '.trim($errorUpload, ' | '):''; 
        $errorUploadType = !empty($errorUploadType)?'File Type Error: '.trim($errorUploadType, ' | '):''; 
        $errorMsg = !empty($errorUpload)?'<br/>'.$errorUpload.'<br/>'.$errorUploadType:'<br/>'.$errorUploadType; 
         
        if(!empty($insertValuesSQL2)){ 
            $insertValuesSQL2 = trim($insertValuesSQL2, ','); 
            // echo "$insertValuesSQL2";
            // Insert image file name into database 
            $insert = $conn->query("INSERT INTO room (`image`, `host_id`,  house, `address`, single_bed, double_bed, city, air_condition, wifi, toilet) VALUES $insertValuesSQL2"); 
            if($insert){ 
            ...
            This week
                ...
                <div class="row row-cols-1 row-cols-md-4 g-4">
                    ...
                    <div class="container">
                        ...
                        <form class="row g-3" action="addRoom.php" method="post" enctype="multipart/form-data">


                            <div class="col-12">
                                <label for="inputAddress" class="form-label">House name</label>
                                <input type="text" name="house" class="form-control" id="inputAddress"
                            ...
                            <div class="col-md-6">
                                <label for="inputCity" class="form-label">Single Bed</label>
                                <input name="sbed" type="number" class="form-control" id="inputCity">
                            </div>

                            <div class="col-md-6">
                                <label for="inputCity" class="form-label">Double Bed</label>
                                <input name="dbed" type="number" class="form-control" id="inputCity">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- <input type="file" name="uploadfile" class="form-control" id="inputCity"> -->
                                <input type="file" name="files[]" class="form-control" id="inputCity" multiple>

                            </div>
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input name="air" class="form-check-input" type="checkbox" value="available"
                                        id="flexCheckDefault">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input name="wifi" class="form-check-input" type="checkbox" value="available"
                                        id="flexCheckDefault">
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Wifi
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input name="toilet" class="form-check-input" type="checkbox" value="available"
                                        id="flexCheckDefault">
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Toilet
                                    </label>
