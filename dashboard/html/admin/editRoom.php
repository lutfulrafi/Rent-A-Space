...
if(isset($_POST['submit'])){
    $sql2="UPDATE room SET house=$house, `address`=$address, single_bed=$sbed, double_bed=$dbed, city=$city, air_condition=$air, wifi=$wifi, toilet=$toilet WHERE room_id=$room_id";
                ...
                <div class="row row-cols-1 row-cols-md-4 g-4">
                    ...
                    <div class="container">
                        ...
                        <div class="col-12">
                                ...
                                <input type="text" name="house" class="form-control" id="inputAddress" placeholder="1234 Main St">
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input name="air" class="form-check-input" type="checkbox" value="available" id="flexCheckDefault" >
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input name="wifi" class="form-check-input" type="checkbox" value="available" id="flexCheckDefault" >
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Wifi
                                    </label>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input name="toilet" class="form-check-input" type="checkbox" value="available" id="flexCheckDefault" >
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Toilet
                                    </label>
                                </div>
