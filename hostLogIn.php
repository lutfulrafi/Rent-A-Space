<?php
    ...
    if(isset($_POST["submit"])){
        ...
        if(emptyInputLogIn($userEmail, $password) !== false){
            header("location:hostLogIn.php?error=emptyinput");
            exit();
        }
        if(logIN_password_match($password,$userEmail)===false){
            header("location:hostLogIn.php?error=wrongInput");
            exit();
        }
...
<head>
    ...
    <body>
        ...
        <div class="sign-up-form">
            ...
            <form action="hostLogIn.php" method="post">
                ...
                <hr>
                <p>OR</p>
                <p>Do not have an account? <a href="hostregister.php">Sign Up Now</a></p>
